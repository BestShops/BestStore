...
public interface HumanMapper {
	...
	@Select("select datediff(concat(substring(current_timestamp(6),1,4),substring(hbirth,5)),current_timestamp(6)) day from human where hid=#{hid}")
	long birthTime(@Param("hid")int hid);
	
	@Select("select datediff(concat(substring(current_timestamp(6),1,4)+1,substring(hbirth,5)),current_timestamp(6)) day from human where hid=#{hid}")
	long birthTime1(@Param("hid")int hid);
