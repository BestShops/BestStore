...
public interface TypeMapper {
	...
	@Select("select t3.tpriname name1,t3.tid tid1,t2.tpriname name2,t2.tid tid2,t1.tpriname name3,t1.tid tid3,g.* " + 
			"from type t1 left join type t2 on t1.tparentid=t2.tid left join type t3 on t2.tparentid=t3.tid left join goods g on t1.tid=g.tid " + 
			"where t1.tparentid is not null and t2.tparentid is not null and gstatus=1 and t3.tid=#{tid} order by gpublish desc limit 0,8")
