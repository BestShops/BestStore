...
<div style="height: 80px">Best Store</div> 
	<div class="main bgf">   
    	<div class="reg-box-pan display-inline">  
        	...
        	<div class="reg-box" id="verifyCheck" style="margin-top:20px;">
            	<div class="part1">                	
                    <div class="alert alert-info" style="width:700px">请输入手机号码并输入短信中的验证码，确保您的手机号真实有效。</div>                    
                    <div class="item col-xs-12 f-mb10" style="height:auto">
                        <span class="intelligent-label f-fl"><b class="ftx04">*</b><select>
                        	<option>手机号</option><option>邮箱</option>
                        </select></span>    
                        <div class="f-fl item-ifo">
                            <input type="text" class="txt03 f-r3 required" tabindex="2" value="15824450934"/> 
                        </div>
                    </div>
